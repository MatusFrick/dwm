...
static const char *fonts[]          = { "Source Code Pro:size=16", "fontawesome:size=16" };
...
static const char *screencmd[] = { "scrot","-d", "3", "/home/mat/Screenshots/%Y-%m-%d-%T-screenshot.png", NULL };
